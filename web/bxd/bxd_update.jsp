    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form id="admin-form" name="addForm" action="/bxd/update" modelAttribute="info">
                    <form:hidden path="bxd.id"/>
                    <div class="panel-body bg-light">
                        <div class="section-divider mt20 mb40">
                            <span> 基本信息 </span>
                        </div>
                        <div class="section">
                            <label for="bxd.cause" class="field prepend-icon">
                                <form:input path="bxd.cause" cssClass="gui-input" placeholder="事由..."/>
                                <label for="bxd.cause" class="field-icon">
                            ...
                            <div>
                                <div class="col-md-3">
                                    <label for="items[${sta.index}].item" class="field prepend-icon">
                                        ...
                                        <form:hidden path="items[${sta.index}].bxdId"/>
                        ...
                        <div class="section row">
                            <div class="col-md-3">
                                <label for="totalMoney" class="field prepend-icon">
                                    <form:input id="totalMoney" path="bxd.totalAmount" cssClass="gui-input" placeholder="总金额..." readonly="true"/>
