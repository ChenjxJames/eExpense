            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-6">${bxd.cause}</div>
                    </div>
                    <div class="section row">
                        <div class="col-md-2">创建人</div>
                        <div class="col-md-4">${bxd.creater.name}</div>
                        <div class="col-md-2">创建时间</div>
                        <div class="col-md-4"><spring:eval expression="bxd.createTime"/></div>
                    </div>
                    <div class="section row">
                        <div class="col-md-2">待处理人</div>
                        <div class="col-md-4">${bxd.dealer.name}</div>
                        <div class="col-md-2">状态</div>
                        <div class="col-md-4">${bxd.status}</div>
                    </div>
                    <div class="section-divider mt20 mb40">
                        <span> 费用明细 </span>
                    </div>
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-6">${bxd.totalAmount}</div>
                    </div>
                    <div class="section-divider mt20 mb40">
                        <span> 处理流程 </span>
                    </div>
                    ...
                    <form:form id="admin-form" name="addForm" action="/bxd/check" modelAttribute="record">
                        <form:hidden path="bxdId" />
                        <div class="panel-body bg-light">
                            <div class="section">
